...
A mutator defines one kind of code change. When you pass a mutator to `test_plan()`, muttest finds every matching pattern in your source file and produces one mutant per match.
...
Start here, look at the survivors, then add more targeted mutators for the specific patterns in your code.
